...
# Mirrors scraper/utils.py INDUSTRY_KEYWORDS — keep in sync
INDUSTRY_KEYWORDS = {
    "Roads & Stormwater":            ["road", "roads", "stormwater", "paving", "asphalt", "pothole"],
    "Buildings & Construction":      ["construction", "building", "civil works", "erection"],
    "Housing & Human Settlement":    ["housing", "human settlement", "rdp", "top structure"],
    "Water & Sanitation":            ["water", "sanitation", "sewage", "reticulation", "reservoir", "borehole"],
    "Electrical & Energy":           ["electrical", "electricity", "substation", "generator", "solar", "metering"],
    "Plumbing & Drainage":           ["plumbing", "pipes", "drainage", "pump"],
    "Fencing & Security Infra":      ["fencing", "fence", "gate", "palisade"],
    "Engineering Services":          ["engineering", "structural", "surveying", "project management"],
    "Town Planning & GIS":           ["town planning", "spatial", "gis", "mapping"],
    "Environmental Services":        ["environmental", "eia", "ecology", "rehabilitation"],
    "Legal Services":                ["legal", "attorney", "litigation", "conveyancing"],
    "Financial & Audit":             ["audit", "accounting", "financial management", "forensic"],
    "Consulting & Advisory":         ["consulting", "advisory", "feasibility", "assessment"],
    "Research & Development":        ["research", "r&d", "innovation", "laboratory"],
    "ICT Infrastructure":            ["network", "fiber", "broadband", "telecommunications", "server"],
    "Software & Systems":            ["software", "system", "application", "erp", "it support"],
    "Hardware & Equipment":          ["hardware", "computer", "laptop", "printer", "equipment supply"],
    "Security Technology":           ["cctv", "access control", "surveillance", "biometric"],
    "Healthcare & Medical":          ["medical", "healthcare", "clinic", "ambulance", "nursing"],
    "Pharmaceuticals":               ["pharmaceutical", "medicine", "medication"],
    "Social Services":               ["social services", "welfare", "community development", "youth"],
    "Education & Training":          ["training", "education", "skills development", "learnership"],
    "Security Services":             ["security", "guarding", "armed response", "crowd control"],
    "Cleaning Services":             ["cleaning", "hygiene", "janitorial", "pest control"],
    "Waste Management":              ["waste", "refuse", "recycling", "landfill"],
    "Facilities Management":         ["facilities management", "maintenance", "repairs", "refurbishment"],
    "Fleet & Transport":             ["fleet", "vehicles", "transport", "buses", "truck"],
    "Catering & Food":               ["catering", "food supply", "meals", "canteen"],
    "Landscaping & Horticulture":    ["landscaping", "gardening", "parks", "grass cutting"],
    "Printing & Stationery":         ["printing", "stationery", "signage", "branding"],
    "Furniture & Office":            ["furniture", "office equipment", "chairs", "desks"],
    "PPE":                           ["ppe", "protective clothing", "safety wear", "overalls"],
    "Uniforms & Workwear":           ["uniform", "workwear", "clothing", "apparel"],
    "Fuel & Lubricants":             ["fuel", "diesel", "petrol", "lubricants"],
    "Tools & Plant Hire":            ["tools", "plant hire", "machinery", "equipment hire"],
    "Mining & Geological":           ["mining", "drilling", "blasting", "mineral", "geological"],
    "Agriculture & Farming":         ["agriculture", "farming", "livestock", "irrigation"],
    "Tourism & Events":              ["tourism", "event management", "conference", "venue"],
    "Insurance":                     ["insurance", "short-term insurance", "risk management"],
    "Property & Real Estate":        ["property", "valuation", "lease", "rental", "land"],
}

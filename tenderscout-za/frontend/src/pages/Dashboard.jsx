 ...
 * saved location (province/town from registration). If the user
 * selected a province during signup, tenders from that province
...
export default function Dashboard() {
  ...
  const getPayload = () => {
    ...
    // KEY: Default to user's province from registration
    ...
    // Always use user's saved location for dashboard
  ...
  // User's location from registration
